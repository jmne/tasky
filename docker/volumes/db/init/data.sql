...
ALTER TABLE "public"."assignment_project"
...
ALTER TABLE "public"."assignment_task"
    OWNER TO "supabase_admin";
...
CREATE POLICY "All rights for project owner" ON "public"."assignment_project" USING (("project_id" IN
                                                                                      (SELECT "project"."id"
                                                                                       FROM "public"."project"
...
CREATE POLICY "Select project for team members" ON "public"."project" FOR SELECT USING (("id" IN
                                                                                         (SELECT "assignment_project"."project_id"
                                                                                          FROM "public"."assignment_project"
                                                                                          WHERE ("auth"."uid"() = "assignment_project"."assignee"))));

CREATE POLICY "Select rights for user in project" ON "public"."assignment_project" FOR SELECT USING (("project_id" IN
                                                                                                      (SELECT "assignment_project_1"."project_id"
...
CREATE POLICY "User in project" ON "public"."task" USING ((("id" IN (SELECT "assignment_task"."task_id"
                                                                     ...
                                                                     WHERE ("assignment_task"."assignee" = "auth"."uid"()))) OR
                                                           ("project" IN (SELECT "project"."id"
                                                                          FROM "public"."project"
                                                                          WHERE ("project"."owner" = "auth"."uid"())))));
